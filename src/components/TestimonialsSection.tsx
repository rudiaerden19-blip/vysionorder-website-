...
function Avatar({ initials }: { initials: string }) {
  return (
    <div
      className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-accent/25 to-accent/10 text-xl font-bold text-accent ring-4 ring-white shadow-md sm:h-28 sm:w-28 sm:text-2xl"
      aria-hidden
    >
      {initials}
    </div>
